...
#[cfg(test)]
pub(crate) mod tests {
    use {super::*, crate::accounts_file::WritableAppendVecProvider, std::path::Path};
    ...
    fn test_shrink_in_progress() {
        ...
        let entry2 = Arc::new(AccountStorageEntry::new::<WritableAppendVecProvider>(
            common_store_path,
            slot,
            id,
            store_file_size2,
    ...
    impl AccountStorage {
        fn get_test_storage_with_id(&self, id: AppendVecId) -> Arc<AccountStorageEntry> {
            ...
            let common_store_path = Path::new("");
            let store_file_size = 4000;
            Arc::new(AccountStorageEntry::new::<WritableAppendVecProvider>(
                common_store_path,
                slot,
                id,
                store_file_size,
