...
impl HotStorageWriter {
    ...
    fn write_account(
        ...
        let store_account_entry_time = Measure::start("store_account_entry");
    ...
    >(
        ...
        let store_index_block_time = Measure::start("store_index_block");
        ...
        let store_owners_block_time = Measure::start("store_owners_block");
        assert!(cursor % HOT_BLOCK_ALIGNMENT == 0);
