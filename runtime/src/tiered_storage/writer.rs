...
use {
    ...
    std::{borrow::Borrow, collections::HashMap, mem, path::Path},
};
...
impl<'format> TieredStorageWriter<'format> {
    ...
    >(
        ...
        match footer.account_meta_format {
            AccountMetaFormat::Hot => info!(
                "[Hot] write_accounts successfully completed. Footer: {:?}",
                footer
            ),
            /*
            AccountMetaFormat::Cold => info!(
                "[Cold] write_accounts successfully completed. Footer: {:?}",
                footer
            ),
            */
        }
    ...
    >(
        ...
        let footer = TieredStorageFooter {
            account_meta_format: self.format.account_meta_format.clone(),
            owners_block_format: self.format.owners_block_format.clone(),
            account_block_format: self.format.account_block_format.clone(),
            account_index_format: self.format.account_index_format.clone(),
