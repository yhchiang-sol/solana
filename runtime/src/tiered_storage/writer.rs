...
impl TieredStorageWriter {
    ...
    >(
        ...
        footer.data_block_format = self.format.data_block_format.clone();
    ...
    fn new_data_block_writer(&self, footer: &TieredStorageFooter) -> AccountDataBlockWriter {
        return AccountDataBlockWriter::new(footer.data_block_format);
    }

    pub(crate) fn write_account_metas_block<T: TieredAccountMeta>(
        &self,
        cursor: &mut u64,
        footer: &mut TieredStorageFooter,
        account_metas: &Vec<T>,
    ) -> std::io::Result<()> {
        let entry_size: u32 = std::mem::size_of::<T>() as u32;
    ...
    fn flush_account_data_block<T: TieredAccountMeta>(
        &self,
        cursor: &mut u64,
        footer: &mut TieredStorageFooter,
    ...
    fn write_blob_account_data_block<T: TieredAccountMeta>(
        &self,
        cursor: &mut u64,
        footer: &mut TieredStorageFooter,
        account_metas: &mut Vec<T>,
