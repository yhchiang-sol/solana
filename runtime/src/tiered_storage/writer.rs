...
use {
    crate::{
        account_storage::meta::{
            AccountMeta, StorableAccountsWithHashesAndWriteVersions, StoredMetaWriteVersion,
        ...
        tiered_storage::{
            ...
            hot::HotAccountMeta,
            index::{AccountIndexWriterEntry, AccountIndexWriterEntry2, HotAccountIndexer},
...
impl TieredStorageWriter {
    ...
    fn write_blob_account_block2<'a, T: TieredAccountMeta>(
        ...
        let optional_fields = AccountMetaOptionalFields {
            ...
            write_version_obsolete: Some(write_version),
        };
