...
pub struct HotAccountIndex {}

impl HotAccountIndex {
    ...
    pub fn get_pubkey_offset(footer: &TieredStorageFooter, index: usize) -> usize {
        footer.account_pubkeys_offset as usize + std::mem::size_of::<Pubkey>() * index
    }
    ...
    pub fn get_meta_offset(
        ...
        let offset = footer.account_pubkeys_offset as usize
            + std::mem::size_of::<Pubkey>() * (footer.account_meta_count as usize)
